#  ---------------------------
#   FileName:                   C3DFeatureExtraction.py
#   Author:                     Feiyang Wang
#   Last Modification Date:     8/11/2020
#   Description:                Processing all UE c3d motion file and getting features vector / file including two parts:
#                               1). 180 Velocity norms by splitting points into 10 bins and averaging each bin with first 18 points/frame
#                               2). EMG Part: 16 Channel's MAV + 160 MAVS by 10 bins with 16 MAVS/bin + 16 Channel's VAR.
#   Appendix:                   None
#  ---------------------------
import sys
sys.path.append('/Users/jack/miniconda3/lib/python3.7/site-packages')
import c3d
import numpy as np
import math
import os
...
rootDir = '/Users/jack/Documents/CS491_Project/Data'
CSVFileName = '/Users/jack/Documents/CS491_Project/InputData.csv'
